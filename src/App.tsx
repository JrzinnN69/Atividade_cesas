...
export default function App() {
  ...
  const allResources: Resource[] = [
    { id: '1', name: 'Quadra Poliesportiva', category: 'Quadra Coberta', image: 'https://images.unsplash.com/photo-1761644273884-83839f8f22e5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg', sportType: 'Coletivo', resourceType: 'Quadra' },
